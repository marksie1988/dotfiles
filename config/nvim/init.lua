...
--
-- This file is managed by Nix (symlinked read-only from the dotfiles repo). To
-- change it: edit config/nvim/init.lua in the repo, then run `dfup`.

-- [[ Leaders — must be set before plugins load ]]
vim.g.mapleader = ' '
vim.g.maplocalleader = ' '
vim.g.have_nerd_font = true -- Hack Nerd Font is installed via Nix
