...
if [[ "$OSTYPE" == "darwin"* ]]; then
  ...
  #sudo scutil --set ComputerName "Marksie"
  #sudo scutil --set HostName "Marksie"
  #sudo scutil --set LocalHostName "Marksie"
  #sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Marksie"
  ...
  # Safari: hide Safari’s bookmark bar by default
  defaults write com.apple.Safari ShowFavoritesBar -bool false

  # Safari: hide Safari’s sidebar in new windows
  defaults write com.apple.Safari ShowSidebarInNewWindowsAtLaunch -bool false
  ...
  # Safari: add a context menu item for inspecting elements in web views
  ...
  # Mail: disable send and receive animations in Mail.app
  ...
  defaults write com.apple.mail NSUserKeyEquivalents -dict-add "Send" "@\U2111"

  # Mail: display threads with the newest messages on top
  ...
  defaults write com.apple.ActivityMonitor SortOrder -int 0

  # Photos: disable it from starting every time a device is plugged in
  defaults -currentHost write com.apple.ImageCapture disableHotPlug -bool true

  # Messages: disable smart quotes as they’re annoying for messages that contain code
